BEGIN TRANSACTION;
DROP TABLE IF EXISTS cashpal_user, account, transfer CASCADE;
...
CREATE SEQUENCE seq_user_id
  ...
  START WITH 1001
  NO MAXVALUE;
CREATE TABLE cashpal_user (
    user_id int NOT NULL DEFAULT nextval('seq_user_id'),
    username varchar(50) NOT NULL,
    password_hash varchar(200) NOT NULL,
    CONSTRAINT PK_cashpal_user PRIMARY KEY (user_id),
...
ALTER TABLE account ADD CONSTRAINT FK_account_cashpal_user FOREIGN KEY (username) REFERENCES cashpal_user (username);
...
--Adding Users--
INSERT INTO cashpal_user (username, password_hash)
